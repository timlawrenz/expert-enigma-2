...
# Custom task to generate the MCP OpenAPI specification
desc "Generate the MCP OpenAPI specification (mcp.json)"
task :generate_mcp_spec do
  puts "Generating MCP OpenAPI specification..."
  
  # Generate the OpenAPI 3.1 specification for the MCP server
  mcp_spec = {
    'openapi' => '3.1.0',
    'info' => {
                ...
                'application/json' => {
                  'schema' => {
                    ...
                    'properties' => {
                      ...
                      'message' => { 'type' => 'string', 'example' => 'Expert Enigma MCP Server is running.' }
                    },
                  ...
                  'schema' => {
                    ...
                    'properties' => {
                      'files' => {
                        'type' => 'array',
                        'items' => { 'type' => 'string' },
                        'example' => ['test/test_file_1.rb', 'test/test_file_2.rb']
                      }
                    },
                    'required' => ['files']
                  }
                    ...
                    'properties' => {
                      'symbols' => {
                        ...
                        'items' => {
                          'type' => 'object',
                          'properties' => {
                            'name' => { 'type' => 'string', 'example' => 'method_one' },
                            'type' => { 'type' => 'string', 'example' => 'method' },
                            'scope' => { 'type' => 'string', 'example' => 'TestModule::TestClass' },
                            'start_line' => { 'type' => 'integer', 'example' => 3 },
                            'end_line' => { 'type' => 'integer', 'example' => 5 }
                          }
                        }
                      }
                    },
                    ...
                    'properties' => {
                      'definitions' => {
                        ...
                        'items' => {
                          'type' => 'object',
                          'properties' => {
                            'name' => { 'type' => 'string', 'example' => 'TestClass' },
                            'type' => { 'type' => 'string', 'example' => 'class' },
                            'scope' => { 'type' => 'string', 'example' => 'TestModule' },
                            'start_line' => { 'type' => 'integer', 'example' => 2 },
                            'end_line' => { 'type' => 'integer', 'example' => 10 },
                            'file_path' => { 'type' => 'string', 'example' => 'test/test_file_1.rb' }
                          }
                        }
                      }
                    },
                    ...
                    'properties' => {
                      'references' => {
                        ...
                        'items' => {
                          'type' => 'object',
                          'properties' => {
                            'symbol_name' => { 'type' => 'string', 'example' => 'method_one' },
                            'start_line' => { 'type' => 'integer', 'example' => 15 },
                            'end_line' => { 'type' => 'integer', 'example' => 15 },
                            'file_path' => { 'type' => 'string', 'example' => 'test/test_file_1.rb' }
                          }
                        }
                      }
                    ...
                    'properties' => {
                      ...
                      'inbound_calls' => {
                        ...
                        'items' => {
                          'type' => 'object',
                          'properties' => {
                            'symbol_name' => { 'type' => 'string', 'example' => 'caller_method' },
                            'start_line' => { 'type' => 'integer', 'example' => 20 },
                            'end_line' => { 'type' => 'integer', 'example' => 20 },
                            'file_path' => { 'type' => 'string', 'example' => 'test/test_file_2.rb' }
                          }
                        }
                      },
                      'outbound_calls' => {
                        ...
                        'items' => {
                          'type' => 'object',
                          'properties' => {
                            'name' => { 'type' => 'string', 'example' => 'called_method' }
                          }
                        }
                      }
                    },
                    'required' => ['method', 'inbound_calls', 'outbound_calls']
                  }
                }
              }
            },
                    ...
                    'properties' => {
                      'results' => {
                        ...
                        'items' => {
                          'type' => 'object',
                          'properties' => {
                            'name' => { 'type' => 'string', 'example' => 'method_name' },
                            'start_line' => { 'type' => 'integer', 'example' => 5 },
                            'end_line' => { 'type' => 'integer', 'example' => 10 },
                            'file_path' => { 'type' => 'string', 'example' => 'test/test_file_1.rb' },
                            'distance' => { 'type' => 'number', 'example' => 0.25 }
                          }
                        }
                      }
                    },
  ...
  # Write the specification to mcp.json
  File.open('mcp.json', 'w') do |f|
    f.write(JSON.pretty_generate(mcp_spec))
  end

  puts "OpenAPI specification generated and saved to mcp.json"
  
  if File.exist?('mcp.json')
    puts "✅ MCP specification generated successfully at mcp.json"
    puts "File size: #{File.size('mcp.json')} bytes"
  else
    puts "❌ Failed to generate MCP specification"
    exit 1
  end
end

# Create an alias that matches the expected rswag naming convention
task 'rswag:specs:swaggerize' => :generate_mcp_spec
